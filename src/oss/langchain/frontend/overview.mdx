...
`useStream` is UI-agnostic. Use it with any React component library:

<CardGroup cols={2}>
  <Card title="AI Elements" icon="layout-grid" href="/oss/langchain/frontend/integrations#ai-elements">
  ...
  <Card title="assistant-ui" icon="message-square" href="/oss/langchain/frontend/integrations#assistant-ui">
