...
Using a provider not listed here? See [Arbitrary providers](/oss/javascript/deepagents/cli/configuration#arbitrary-providers): any LangChain-compatible provider can be used in the CLI with some additional setup.
