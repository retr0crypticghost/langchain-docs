...
Open-weight models are available through providers like [OpenRouter](/oss/python/integrations/providers/openrouter), [Baseten](/oss/python/integrations/providers/baseten), and [Ollama](/oss/python/integrations/providers/ollama).
